// ===================================================
// KONFIGURASI PERSENTASE KEMENANGAN (EASY RTP CONTROL)
// ===================================================
const RTP_CONFIG = {
    ...
    goldFrameFreeSpin: 0.32,  // Mode Free Spin (32%)

    // Bobot kemunculan simbol biasa (Total bernilai 1.0)
    // Urutan: [Simbol 0, 1, 2, 3, 4, 5, 6]
    // Simbol 0-2 (kecil), Simbol 3-4 (sedang), Simbol 5-6 (besar)
    symbolWeights: [
        0.18, // Simbol 0 (18%)
        0.18, // Simbol 1 (18%)
        0.18, // Simbol 2 (18%)
    ...
    // Tabel Pengali Nilai Bayaran per Simbol
    baseOddsTable: [10, 15, 20, 30, 40, 60, 80],

    // Perkalian (Multiplier) Runtuhan Kemenangan
    normalMultipliers: [1, 2, 3, 5],
...
const NORMAL_MULTIPLIERS = RTP_CONFIG.normalMultipliers;
const FREE_SPIN_MULTIPLIERS = RTP_CONFIG.freeSpinMultipliers;
